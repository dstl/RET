...
from ret.behaviours.behaviourpool import BehaviourHandlers
from ret.behaviours.move import MoveInBandBehaviour
    ...
    def _get_possible_tasks(self, agent: RetAgent) -> list[bool]:
        ...
        Returns:
            list[bool]: A list of bools where each element specifies if the given agent
                can perform the task associated with that index position
        """
        can_none: bool = True
        can_wait: bool = (
            len(
