...
from ret.agents.agent import RetAgent, AgentType, AgentCasualtyState
from ret.agents.sensorfusionagent import SensorFusionAgent
from ret.orders.order import CompoundAndTrigger, CompoundOrTrigger
...
from ret.orders.triggers.sensor import IlluminatedBySensorTrigger
...
from ret.space.feature import LineFeature, SphereFeature
...
class TestTriggers(TestCase):
    ...
    def test_trigger_get_new_instance_sticky_status_maintained_not_triggered(self):
        """Test the sticky status maintained method without triggering."""
    ...
    def test_trigger_get_new_instance_sticky_status_maintained_triggered(self):
        """Test the sticky status maintained method with triggering."""
        trigger = PositionTrigger(self.agent, (10, 10), 1)
        sticky_trigger = PositionTrigger(self.agent, (10, 10), 1, sticky=True)
    ...
    def test_agent_sensed_trigger_sticky(self):
        """Test sticky variant of agent sensed trigger."""
        agent_sensed = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            agent_types=[AgentType.GENERIC],
        ...
        assert not agent_sensed.is_active(checking_agent)
        checking_agent.perceived_world.add_agent(self.agent)
        assert agent_sensed.is_active(checking_agent)
        self.agent._killed = True
        assert agent_sensed.is_active(checking_agent)

    def test_agent_sensed_trigger_not_sticky_casualty(self):
        """Test non-sticky variant of agent sensed trigger."""
        agent_sensed = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            agent_types=[AgentType.GENERIC],
    ...
    def test_agent_sensed_trigger_not_sticky_affiliation(self):
        """Test non-sticky variant of agent sensed trigger."""
        agent_sensed = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
        ...
        checking_agent.perceived_world.add_agent(self.agent)
        assert agent_sensed.is_active(checking_agent)
        self.agent.affiliation = Affiliation.HOSTILE
        assert not agent_sensed.is_active(checking_agent)

    def test_agent_sensed_trigger_not_sticky_confidence(self):
        """Test non-sticky variant of agent sensed trigger."""
        agent_sensed = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.RECOGNISE,
            agent_types=[AgentType.GENERIC],
            casualty_state=AgentCasualtyState.ALIVE,
        )
        checking_agent = RetAgent(
        ...
        checking_agent.perceived_world.add_agent(self.agent)
        assert agent_sensed.is_active(checking_agent)
        checking_agent.perceived_world._agents.clear()
        assert not agent_sensed.is_active(checking_agent)

    def test_agent_sensed_trigger_not_sticky_agent_type(self):
        """Test non-sticky variant of agent sensed trigger."""
        agent_sensed = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.RECOGNISE,
        ...
        checking_agent.perceived_world.add_agent(self.agent)
        assert agent_sensed.is_active(checking_agent)
        self.agent.agent_type = AgentType.AIR
        assert not agent_sensed.is_active(checking_agent)

    def test_agent_sensed_trigger_get_new_instance(self):
        """Test the agent sensed trigger get_new_instance method."""
        trigger = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            agent_types=[AgentType.GENERIC],
            casualty_state=AgentCasualtyState.ALIVE,
        ...
        assert trigger is not clone
        assert isinstance(clone, AgentsSensedTrigger)
        assert trigger._agent_types == clone._agent_types
        assert trigger._sticky == clone._sticky
        assert trigger._log == clone._log
        assert trigger._invert == clone._invert

    def test_agent_sensed_trigger_str_method(self):
        """Test the agent sensed trigger string method."""
        trigger = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            agent_types=[AgentType.GENERIC],
        ...
        assert str(trigger) == "Agents Sensed Trigger"

    def test_agent_sensed_trigger_log_method(self):
        """Test the agent sensed trigger _get_log_message."""
        trigger = AgentsSensedTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            agent_types=[AgentType.GENERIC],
    ...
    def test_agent_sensed_in_range_trigger_sticky(self):
        """Test sticky variant of agent sensed in range trigger."""
        agent_sensed = AgentsSensedInRangeTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            sense_range=1000,
            agent_types=[AgentType.GENERIC],
    ...
    def test_agent_sensed_in_range_trigger_not_sticky(self):
        """Test non-sticky variant of agent sensed in range trigger."""
        agent_sensed = AgentsSensedInRangeTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            sense_range=1000,
    ...
    def test_agent_sensed_in_range_trigger_get_new_instance(self):
        """Test the agent sensed in range trigger get_new_instance method."""
        trigger = AgentsSensedInRangeTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            sense_range=1000,
            agent_types=[AgentType.GENERIC],
        ...
        assert trigger is not clone
        assert isinstance(clone, AgentsSensedInRangeTrigger)
        assert trigger._agent_types == clone._agent_types
        assert trigger._sticky == clone._sticky
        assert trigger._log == clone._log
        assert trigger._invert == clone._invert

    def test_agent_sensed_in_range_trigger_str_method(self):
        """Test the agent sensed in range trigger string method."""
        trigger = AgentsSensedInRangeTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            sense_range=1000,
        ...
        assert str(trigger) == "Agents Sensed In Range Trigger"

    def test_agent_sensed_in_range_trigger_log_method(self):
        """Test the agent sensed in range trigger _get_log_message."""
        trigger = AgentsSensedInRangeTrigger(
            agent_affiliation=Affiliation.FRIENDLY,
            confidence_level=Confidence.IDENTIFY,
            sense_range=1000,
