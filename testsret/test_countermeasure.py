...
from ret.agents.agentfilter import AgentFilter, FilterByAffiliation
...
from ret.testing.mocks import MockAgentWithAffiliation, MockCountermeasure, MockModel3d
...
class TestCountermeasure(unittest.TestCase):
    ...
    def test_get_clutter_modifier(self):
