...
from ret.communication.communicationnetwork import (
    CommunicationNetwork,
    CommunicationNetworkModifier,
)
from ret.communication.network_setup_utility import network_setup_complete_graph
...
class TestCommunicationNetwork(unittest.TestCase):
    ...
    def test_network_setup_utility(self):
