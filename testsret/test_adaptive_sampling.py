...
from ret.sampling import AdaptiveSamplerInvalidDefaultValueError, GradientAdaptiveSampler
...
from ret.testing.mocks import MockParametrisedModel  # noqa: TC002
...
class TestRetModel(RetModel):
    ...
    def __init__(
        self,
        n_friendly_agents: int,
        n_hostile_agents: int,
        output_folder: str = "./output/TestRet",
        **kwargs,
    ):
        """Initialise model.
        ...
        super().__init__(
            ...
            log_config="all",
            playback_writer=JsonWriter(output_folder_name=self.output_folder_path),
            **kwargs,
        )
