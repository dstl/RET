...
class TestFieldOfView(unittest.TestCase):
    ...
    @patch("ret.utilities.geometric_utilities._heading_to_clockwise_angle_degrees")
    def test_reduce_to_field_of_view(
        self,
        view_angle: float,
        headings_viewable: list[float],
        headings_nonviewable: list[float],
        mock_heading_to_clockwise_angle_degrees: Mock,
    ):
        """Parametrised unit test of the Sensor.reduce_to_field_of_view method.
        ...
        Args:
            ...
            mock_heading_to_clockwise_angle_degrees (Mock): Mock of
                _heading_to_clockwise_angle_degrees that will return predefined values so
        ...
        gu._heading_to_clockwise_angle_degrees.side_effect = [  # type:ignore
    ...
    def test_run_detection(
        ...
        if sense_direction:
            ...
            assert len(w) == 1
            assert "No sense direction provided for a sensor with view angle of 90" in str(
                w[0].message
            )
