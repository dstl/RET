...
class VisualizationTestingBase:
    ...
    def test_with_background(self):
        ...
        canvas = self.get_canvas(None, 100, 100, canvas_background_file=canvas_background_path)
        assert canvas.js_code == (
            f"elements.push(new {self.get_canvas_module_name()}"
            "(500, 500, 100, 100, '/assets/background_image.png'));"
        )
...
class TestContinuousVisualization(TestCase):
    ...
    def test_with_background(self):
        ...
        assert canvas.canvas_background_path == "/assets/background_image.png"
        assert canvas.js_code == (
            "elements.push(new CanvasContinuousModule(100, 100, "
    ...
    def test_background_image_stretching(self):
        ...
        assert "image aspect ratio differs from the space aspect ratio by more than 5%," in str(
            w[0].message
        )
...
class TestBarChartVisualization(TestCase):
    ...
    def test_barchartmodule_render_method_no_scope(self):
        """."""
        chart = BarChartModule([{"Label": "Field name", "Color": "#ff0000"}], scope="Test")
    ...
    def test_barchartmodule_render_method_model_scope(self):
        """."""
        chart = BarChartModule([{"Label": "Field name", "Color": "#ff0000"}], scope="model")
