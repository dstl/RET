...
class TestFixedBatchRunner(unittest.TestCase):
    ...
    def test_fixed_and_variable_params(self):
        ...
        model_vars = batch.get_model_vars_dataframe()
        expected_cols = (
            len(self.parameters_list[0]) + len(self.fixed_params) + len(self.model_reporters) + 1
        )  # extra column with run index
...
class MockModelColumns(MockModel):
    ...
    def __init__(
        ...
        **kwargs
        ...
        """."""
        super().__init__(
            variable_model_param, variable_agent_param, fixed_model_param, schedule, **kwargs
        )
...
class TestBatchRunner(unittest.TestCase):
    ...
    def test_model_with_dict_variable_params(self):
        ...
        self.assertEqual(model_vars["reported_variable_value"][self.model_runs - 1]["mvar1"], 2)
        self.assertEqual(model_vars["reported_variable_value"][self.model_runs - 1]["mvar2"], 2)
