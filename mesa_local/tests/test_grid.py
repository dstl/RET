...
class TestMultiGridReproducibility(unittest.TestCase):
    ...
    def test_agent_order(self):
        """."""
        agent_list1 = self.grid1.get_cell_list_contents((0, 0))
        agent_list2 = self.grid2.get_cell_list_contents((0, 0))

        ids1 = list(map(lambda n: n.unique_id, agent_list1))
        ids2 = list(map(lambda n: n.unique_id, agent_list2))
