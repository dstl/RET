...
class CanvasHexGrid(VisualizationElement):
    """A CanvasHexGrid object functions similarly to a CanvasGrid object.

    It takes a portrayal dictionary and talks to HexDraw.js to draw that shape.
    ...
    def __init__(
        ...
        Args:
            ...
            grid_width:,
            grid_height: Size of the grid, in cells.
            canvas_height:,
