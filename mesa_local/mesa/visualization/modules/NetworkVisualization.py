...
Module for rendering the network, using [sigma.js](http://sigmajs.org/)
 or [d3.js](https://d3js.org/) frameworks.
...
class NetworkModule(VisualizationElement):
    ...
    def __init__(self, portrayal_method, canvas_height=500, canvas_width=500, library="sigma"):
        ...
        new_element = "new NetworkModule({}, {})".format(self.canvas_width, self.canvas_height)
