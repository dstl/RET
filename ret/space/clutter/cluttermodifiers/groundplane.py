...
class GroundPlaneClutterModifier(ClutterModifier):
    ...
    If in 2D space then this modifier is assumed to affect all space
    """
    ...
    def __init__(
        ...
        Args:
            ...
            expiry_time (datetime, optional): The time that this modifier will stop being
    ...
    def _is_affected(self, pos: Coordinate2dOr3d) -> bool:
        ...
        if len(pos) == 2:
            ...
            # Mypy is not sophisticated enough to realise that a position here must
