...
from ret.space.culture import default_culture
from ret.space.imageutils import check_image_aspect_ratio, get_image_pixel_size
from ret.types import Color  # noqa: TC001
...
if TYPE_CHECKING:
    ...
    from ret.space.terrain import PointGenerator, Terrain
...
class CultureMap:
    ...
    def __init__(
        ...
        if image_path is not None:
            ...
            initial_image = imageio.imread(image_path, mode="RGB")
    ...
    def check_culture_penetration(
        ...
        Args:
            ...
            point_generator (PointGenerator): Function that takes in two positions and a sample
                ...
                separated by the sample distance
