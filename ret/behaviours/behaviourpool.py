...
class BehaviourPool:
    ...
    def add_behaviour(self, behaviour: Behaviour) -> None:
        ...
        if not add_new:
            warnings.warn(f"Cannot add duplicate behaviour '{behaviour.name}'", stacklevel=2)
    ...
    def remove_behaviour(self, behaviour: Behaviour) -> None:
        ...
        if behaviour in self._candidates:
            ...
            name = behaviour.name
            warnings.warn(f"Cannot remove non-existent behaviour '{name}'", stacklevel=2)
