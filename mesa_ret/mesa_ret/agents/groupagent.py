...
if TYPE_CHECKING:
    ...
    from mesa_ret.behaviours.communicate import CommunicateOrdersBehaviour
...
class GroupAgent(RetAgent):
    ...
    def create_scheduler(self) -> None:
        ...
        """
        if type(self.model.schedule) == RandomActivation:
            self.schedule = RandomActivation(self.model)
        elif type(self.model.schedule) == BaseScheduler:
