...
from mesa_ret.behaviours.behaviourpool import NoEqualityAdder
...
from mesa_ret.communication.sensorfusionreceiver import FusionWorldviewHandler
from mesa_ret.logger.logger import LogConfig, RetLogger
from mesa_ret.model import RetModel
from mesa_ret.orders.order import Order, TaskLogStatus, TriggerLogStatus
...
if TYPE_CHECKING:
    ...
    from mesa_ret.orders.order import Task, Trigger
...
class TestLogging(unittest.TestCase):
    ...
    def test_datacollector_created_correctly_all_logging(self):
        ...
        assert datacollector is not None
        assert len(datacollector.tables) == 9
    ...
    def test_datacollector_observations_headers(self):
        ...
        assert len(observation_record) == 12
    ...
    def test_datacollector_perceptions_headers(self):
        ...
        assert len(perception_record) == 6
    ...
    def test_datacollector_behaviour_selection_headers(self):
        ...
        assert len(behaviour_selection) == 7
    ...
    def test_aircraft_move_behaviour_log_message(self):
        ...
        assert (
            AircraftMoveBehaviour(base_speed=10, height_bands=[],)._get_log_message(
                move_start_location=(0, 0, 0),
                move_end_location=(1, 1, 1),
                move_destination=(2, 2, 2),
            )
...
def test_not_log_agent_on_agent_creation():
    """Test agent logging using the agent constructor behaves correctly."""
