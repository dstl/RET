...
class TestModelParameters(unittest.TestCase):
    ...
    def test_get_model(self):
        """Get model class."""
        model = get_model("mesa_ret.testing.mocks", "MockParametrisedModel")
        assert model == MockParametrisedModel

    def test_get_model_parameters(self):
        """Get model parameters from class."""
        params = get_model_parameters("mesa_ret.testing.mocks", "MockParametrisedModel")
    ...
    def test_get_choices(self):
        ...
        choices = get_categoric_parameter_options(
            "mesa_ret.testing.mocks", "MockParametrisedModel", "c1"
        )
    ...
    def test_get_choices_error(self):
        ...
        with self.assertRaises(ValueError) as e:
            get_categoric_parameter_options(
                "mesa_ret.testing.mocks", "MockParametrisedModel", "InvalidParam"
            )
        self.assertEqual(
    ...
    def test_get_min_max(self):
        """Test acessing min/max values for a numeric parameter."""
        min_val, max_val = get_numeric_min_max_values(
            "mesa_ret.testing.mocks", "MockParametrisedModel", "n1"
        )
