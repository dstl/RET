...
class MockGymModelWithKwargs(MockGymModel):
    ...
    def __init__(self, arg_1: int):
        ...
        Args:
            arg_1 (int): Data to store within model for testking kwargs
        """
        super().__init__()
        self.arg_1 = arg_1
...
class TestGym(unittest.TestCase):
    ...
    @unittest.skip("skip")  # TODO: fill in tests when render method complete
    def test_render_human(self):
        """Test the human rendering method for the environment.
    ...
    def test_render_rgb_array(self):
        """Test the RGB rendering method for the environment.
