...
from mesa_ret.agents.agentfilter import FilterByAffiliation, FilterFriendly, FilterNeutral
...
from mesa_ret.orders.order import CompoundTask, Order
from mesa_ret.orders.tasks.communicate import (
...
from mesa_ret.orders.tasks.hide import HideTask
from mesa_ret.orders.tasks.move import MoveTask
from mesa_ret.orders.tasks.operate import OperateTask
...
from mesa_ret.sensing.perceivedworld import AffiliatedAgents, AgentById, Confidence, PerceivedAgent
...
class TestTasks(TestCase):
    ...
    def test_compound_task_str_method(self):
