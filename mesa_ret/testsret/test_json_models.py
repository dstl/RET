...
class TestRetPlayStepData(unittest.TestCase):
    ...
    def test_init(self):
        ...
        retplay_step_data = RetPlayStepData.from_model(0, retplay_agent_list)
...
class TestJsonOutObject(unittest.TestCase):
    ...
    def test_add_timestep_data(self):
        ...
        json_out_object.add_timestep_data(0, self.retplay_agent_list)
    ...
    def test_add_invalid_timestep_data(self):
        ...
        with self.assertRaises(ValueError) as e:
            json_out_object.add_timestep_data(None, self.retplay_agent_list)
        self.assertEqual(
