...
from mesa_ret.agents.agent import AgentConstructionError, RetAgent
...
from mesa_ret.testing.mocks import MockGroupAgentOrderWithId, MockModel2d, MockOrderWithId
...
class TestGroupAgent(unittest.TestCase):
    ...
    def test_wrong_scheduler(self):
        ...
        assert type(new_groupagent.schedule) is BaseScheduler
